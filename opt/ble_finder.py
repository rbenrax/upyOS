...
# Optimized for Xiaomi Buds 4 detection, and others manufacturers
...
def __main__(args):
    ...
    if "--h" in args:
        print("ble_finder - BLE headphone finder")
        print("Usage: ble_finder [MAC_PART] [-mfr ID1,ID2] [-key K1,K2] [-tx N] [-n FACTOR]")
        print()
        ...
        print()
        print("Example: ble_finder AA:BB:CC")
